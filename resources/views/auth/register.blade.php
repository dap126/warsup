...
<body class="bg-gray-50 flex items-center justify-center min-h-screen font-[Inter]">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            <h2 class="text-2xl font-bold text-center mb-8 text-gray-800">Daftar Admin Baru</h2>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500" required>
                </div>
                ...
                <div class="mt-4 text-center">
                    <a href="{{ route('login') }}" class="text-sm text-blue-600 hover:underline">Sudah punya akun? Masuk disini.</a>
                </div>
            </form>
        </div>
    </div>
